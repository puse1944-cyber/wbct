...
?>
        <section class="content">
            <header class="content__title">
                <h1>Dashboard <small>Bienvenido de nuevo, <?php echo isset($user_info["username"]) ? htmlspecialchars($user_info["username"]) : 'Usuario'; ?>!</small></h1>
            </header>
            <div class="row quick-stats">
                <div class="col-sm-6 col-md-3">
                    <div class="quick-stats__item">
                        <div class="quick-stats__info">
                            <h2><?php echo isset($user_info["creditos"]) ? htmlspecialchars($user_info["creditos"]) : '0'; ?></h2>
                            <small>Mis Créditos</small>
                        </div>
